...
<div class="myBack">
	...
	<form action="/hrms/updateVariableDeduction" method="post">
		<div class="row">
			<div class="col-lg-1">
			 <input type="hidden" value="${variableDeduction.id}" name="varid"/>
			</div>
			<div class="col-lg-3">
				<h3 class="display-5">Edit Variable Deduction</h3>
			</div>
			...
			<div class="col-lg-5">
				...
				<div class="form-group">
					...
					<label for="description" class="col-lg-3-3 control-label">Description
						...
						value="${variableDeduction.description}" >
				</div>
			...
			<div class="col-lg-5">
				...
				<div class="form-group">
					<label for="amount" class="col-lg-3-3 control-label">Amount
						...
						name="amount" value="${variableDeduction.amount}"> </select>
				</div>
				<!--<button type="submit" class="btn btn-default">Submit</button>-->
			...
			<div class="col-lg-5">
				...
				<div class="form-group">
					<label for="new_salary" class="col-lg-3-3 control-label">Mode
						...
						name="mode" value="${variableDeduction.mode}"> 

...
<div class="FormLayout">
	<div class="FullSizeLayoutCenter" id="LeaveType">
		...
		<c:url var="addAction" value="/holiday/add"></c:url>

		<form:form style="margin:0% 0% 3% 0%;" id="register-form"
			action="${addAction}" commandName="holiday">
			<fieldset>
				...
				<div class="form-group">
					<label class="col-form-label" for="inputDefault">Holiday
						Reason:</label>
					<form:textarea path="reason" placeholder="Holiday Reason"
		...
		<table class="table table-hover">
			<thead>
				<tr>
					...
					<th scope="col" bgcolor="#5fc1e8">Holiday Reason</th>
			...
			<tbody>
				<c:forEach items="${holidays}" var="holidays">

...
<div class="myBack">
	...
	<form action="/hrms/updateSalary" method="post">
		<div class="row">
			<div class="col-lg-1">
				<input type="hidden" name="empID" value="${employee.id}">
			</div>
			<div class="col-lg-3">
				<h3 class="display-5">Salary Editing</h3>
			</div>

		</div>
		<hr
			style="background-color: dimgrey; color: dimgrey; border: solid 1px dimgrey; height: 1px;" />
		<h6 style="margin-left: 93px; color: #e63900">Salary Details</h6>
		...
		<div class="row">
			...
			<div class="col-lg-5">
				...
				<div class="form-group">
					...
					<label for="fullname" class="col-lg-3-3 control-label">Full Name
						</label> <input type="text" class="form-control" name="fullname"
						value="${employee.nameInFull}"readOnly>
				</div>
			...
			<div class="col-lg-5">
				...
				<div class="form-group">
					<label for="current_salary" class="col-lg-3-3 control-label">Current Salary
						</label> <input type="text" class="form-control"
						name="current_salary" value="${employee.basicSalary}" readOnly> </select>
				</div>
				<!--<button type="submit" class="btn btn-default">Submit</button>-->
		...
		<div class="row">
			...
			<div class="col-lg-5">
				...
				<div class="form-group">
					<label for="new_salary" class="col-lg-3-3 control-label">New Salary
						</label> <input type="text" class="form-control"
						name="new_salary" placeholder="New Salary"> </select>
				</div>
				<!--<button type="submit" class="btn btn-default">Submit</button>-->
		...
		<div class="row">
			...
			<div class="col-lg-5" style="text-align: right">
				<a href="/hrms/salaryAdjustment" style="width: 30%" class="btn btn-success">Cancel</a>
				<button style="width: 30%" type="submit" class="btn btn-success">Edit</button>
			</div>
			<br> <br> <br>
		</div>
	</form>

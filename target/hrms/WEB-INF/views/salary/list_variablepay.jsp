...
<div class="FormLayout">
	<ol class="breadcrumb" style="margin-top: 0%">
		...
		<li class="breadcrumb-item active">Variable Pay</a></li>
	</ol>
</div>
...
<div class="FormLayout">
	...
	<a style="float: right; margin-right: 2%; margin-bottom: 2%"
		href="addVariablePay" class="btn btn-success">New Variable Pay</a>
	<div style="padding: 1%">
			...
			<tbody>
				<c:forEach items="${variablepays}" var="variablepays">
					...
					<tr class="table-light">
						...
						<td>${variablepays.id}</td>
						<td>${variablepays.description}</td>
						<td>${variablepays.amount}</td>
						<td>${variablepays.mode}</td>
						<td style="text-align: center;"><a href="editVariablePay/${variablepays.id}"><i
								class="glyphicon glyphicon-edit"></i></a></td>
						<td style="text-align: center;"><a href="deleteVariablePay/${variablepays.id}"><i

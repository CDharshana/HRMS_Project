<%@page import="com.intervest.hrms.model.VariablePay"%>
...
<div class="myBack">
	...
	<form action="/hrms/updateVariablePay" method="post">
		<div class="row">
			<div class="col-lg-1">
			 <input type="hidden" value="${variablePay.id}" name="varid"/>
			</div>
			<div class="col-lg-3">
				<h3 class="display-5">Edit Variable Pay</h3>
			</div>
			...
			<div class="col-lg-5">
				...
				<div class="form-group">
					<label for="amount" class="col-lg-3-3 control-label">Amount
						...
						name="amount" value="${variablePay.amount}"> </select>
				</div>
				<!--<button type="submit" class="btn btn-default">Submit</button>-->
			...
			<div class="col-lg-5">
				...
				<div class="form-group">
					<label for="new_salary" class="col-lg-3-3 control-label">Mode
						...
						name="mode" value="${variablePay.mode}"> 
		...
		<div class="row">
			...
			<div class="col-lg-5" style="text-align: right">
				<a href="variablepay" style="width: 30%" class="btn btn-success">Cancel</a>

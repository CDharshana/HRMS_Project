...
<div class="FormLayout">
	<ol class="breadcrumb" style="margin-top: 0%">
		...
		<li class="breadcrumb-item active">Leave Periods</li>
	</ol>
</div>
...
<div class="FormLayout">
	<div class="FullSizeLayoutCenter" id="LeaveType">
		...
		<c:url var="addAction" value="/leavePeriod/add"></c:url>

		<form:form style="margin:0% 0% 3% 0%;" id="register-form"
			action="${addAction}" commandName="leavePeriod">
			<fieldset>
				<legend>Leave Periods</legend>
				<div class="form-group">
					<label class="col-form-label" for="inputDefault">Date From:</label>
					<form:input type="date" path="fromDate" class="form-control"
						placeholder="Leave type" id="date_from" />
				</div>
				<div class="form-group">
					<label class="col-form-label" for="inputDefault">Date To:</label>
					<form:input type="date" path="toDate" class="form-control"
						placeholder="Leave type" id="date_to" />
				</div>
				<div class="form-group">
					<label class="col-form-label" for="inputDefault">Leave
						Reason:</label>
					<form:textarea path="reason" placeholder="Leave Reason"
						class="form-control" cols="10" rows="3" />
				</div>
	...
	<div class="FullSizeLayout">
		...
		<table class="table table-hover">
			...
			<tbody>
				<c:forEach items="${leavePeriods}" var="leavePeriods">
					<tr class="table-light">

						<td>${leavePeriods.fromDate}</td>
						<td>${leavePeriods.toDate}</td>
						<td>${leavePeriods.reason}</td>

...
<div class="FullSizeLayoutCenter">
	<br>
	<c:url var="addAction" value="/leaveEntitlements/add"></c:url>

	<form:form style="margin:0% 0% 3% 0%;" id="register-form"
		action="${addAction}" commandName="leaveEntitlement">
		<fieldset>
			<legend>Add Leave Entitlements</legend>

			<div class="row">
				<div class="col form-group">
					<!-- From Date -->
					<label for="FromDate">Upload Date</label>
			...
			<div class="row">
				<div class="col form-group">
					<label for="LeaveType">Employee</label> <select name="employee"
				...
				<div class="col form-group">
					<label for="LeaveType">Leave Type</label> <select name="leaveTypes"
			...
			<div class="row">
				<div class="col form-group ">
					<label for="NumberOfHolidays">Leave amount</label> <input
						type="number" class="form-control" name="leaveAmount"
						id="leaveAmount" value="0" required>
				</div>
